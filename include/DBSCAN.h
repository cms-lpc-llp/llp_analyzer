...
public:
    ...
    int result(int &nClusters, int cscLabels[], int clusterSize[],  float clusterEta[], float clusterPhi[], float clusterRadius[]);
    int clusterMoments(int &nClusters, float clusterMajorAxis[], float clusterMinorAxis[], float clusterEtaSpread[], float clusterPhiSpread[],float clusterEtaPhiSpread[],float clusterEta[], float clusterPhi[], int clusterSize[]);
