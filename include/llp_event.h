...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nTaus;
   Float_t         tauE[10];   //[nTaus]
   Float_t         tauPt[10];   //[nTaus]
   Float_t         tauEta[10];   //[nTaus]
   Float_t         tauPhi[10];   //[nTaus]
   Bool_t          tau_IsLoose[10];   //[nTaus]
   Bool_t          tau_IsMedium[10];   //[nTaus]
   Bool_t          tau_IsTight[10];   //[nTaus]
   Bool_t          tau_passEleVetoLoose[10];   //[nTaus]
   Bool_t          tau_passEleVetoMedium[10];   //[nTaus]
   Bool_t          tau_passEleVetoTight[10];   //[nTaus]
   Bool_t          tau_passMuVetoLoose[10];   //[nTaus]
   Bool_t          tau_passMuVetoMedium[10];   //[nTaus]
   Bool_t          tau_passMuVetoTight[10];   //[nTaus]
   UInt_t          tau_ID[10];   //[nTaus]
   Float_t         tau_combinedIsoDeltaBetaCorr3Hits[10];   //[nTaus]
   Float_t         tau_chargedIsoPtSum[10];   //[nTaus]
   Float_t         tau_neutralIsoPtSum[10];   //[nTaus]
   Float_t         tau_puCorrPtSum[10];   //[nTaus]
   Float_t         tau_eleVetoMVA[10];   //[nTaus]
   Int_t           tau_eleVetoCategory[10];   //[nTaus]
   Float_t         tau_muonVetoMVA[10];   //[nTaus]
   Float_t         tau_isoMVAnewDMwLT[10];   //[nTaus]
   Float_t         tau_isoMVAnewDMwoLT[10];   //[nTaus]
   Float_t         tau_leadCandPt[10];   //[nTaus]
   Int_t           tau_leadCandID[10];   //[nTaus]
   Float_t         tau_leadChargedHadrCandPt[10];   //[nTaus]
   Int_t           tau_leadChargedHadrCandID[10];   //[nTaus]
   ...
   Float_t         dtRechitCluster_match_gParticle_minDeltaR[10];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_gParticle_index[10];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_gParticle_id[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterX[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterY[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterZ[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterTime[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterTimeSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterGenMuonDeltaR[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMajorAxis[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMinorAxis[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEtaPhiSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterPhiSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEtaSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterXSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterYSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterZSpread[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterPhi[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEta[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoPt[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoE[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMuonVetoPt[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMuonVetoE[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterCaloJetVeto[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterSize[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxStation[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxStationRatio[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNChamber[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxChamber[10];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxChamberRatio[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation1[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation2[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation3[10];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation4[10];   //[nDtRechitClusters]
   Int_t           nRpc;
   ...
   Int_t           nDtSeg;
   Float_t         dtSegPhi[300];   //[nDtSeg]
   Float_t         dtSegEta[300];   //[nDtSeg]
   Float_t         dtSegX[300];   //[nDtSeg]
   Float_t         dtSegY[300];   //[nDtSeg]
   Float_t         dtSegZ[300];   //[nDtSeg]
   Int_t           dtSegStation[300];   //[nDtSeg]
   Int_t           dtSegWheel[300];   //[nDtSeg]
   Float_t         dtSegTime[300];   //[nDtSeg]
   Float_t         dtSegTimeError[300];   //[nDtSeg]
   ...
   Int_t           nTracks;
   Float_t         track_Pt[1000];   //[nTracks]
   Float_t         track_Eta[1000];   //[nTracks]
   Float_t         track_Phi[1000];   //[nTracks]
   Int_t           track_charge[1000];   //[nTracks]
   Int_t           track_bestVertexIndex[1000];   //[nTracks]
   Int_t           track_nMissingInnerHits[1000];   //[nTracks]
   Int_t           track_nMissingOuterHits[1000];   //[nTracks]
   Int_t           track_nPixelHits[1000];   //[nTracks]
   Int_t           track_nHits[1000];   //[nTracks]
   Float_t         track_dxyToBS[1000];   //[nTracks]
   Float_t         track_dxyErr[1000];   //[nTracks]
   Float_t         track_dzToPV[1000];   //[nTracks]
   Float_t         track_dzErr[1000];   //[nTracks]
   Float_t         track_chi2[1000];   //[nTracks]
   Int_t           track_ndof[1000];   //[nTracks]
   Int_t           nJets;
   ...
   UInt_t          nFatJets;
   Float_t         fatJetE[10];   //[nFatJets]
   Float_t         fatJetPt[10];   //[nFatJets]
   Float_t         fatJetEta[10];   //[nFatJets]
   Float_t         fatJetPhi[10];   //[nFatJets]
   Float_t         fatJetCorrectedPt[10];   //[nFatJets]
   Float_t         fatJetPrunedM[10];   //[nFatJets]
   Float_t         fatJetTrimmedM[10];   //[nFatJets]
   Float_t         fatJetFilteredM[10];   //[nFatJets]
   Float_t         fatJetSoftDropM[10];   //[nFatJets]
   Float_t         fatJetCorrectedSoftDropM[10];   //[nFatJets]
   Float_t         fatJetUncorrectedSoftDropM[10];   //[nFatJets]
   Float_t         fatJetTau1[10];   //[nFatJets]
   Float_t         fatJetTau2[10];   //[nFatJets]
   Float_t         fatJetTau3[10];   //[nFatJets]
   Float_t         fatJetMaxSubjetCSV[10];   //[nFatJets]
   Bool_t          fatJetPassIDLoose[10];   //[nFatJets]
   Bool_t          fatJetPassIDTight[10];   //[nFatJets]
   Int_t           fatJetNPFCands[10];   //[nFatJets]
   Int_t           fatJetPFCandIndex[10][5000];   //[nFatJets]
   Float_t         metPt;
   Float_t         metPhi;
   Float_t         sumMET;
