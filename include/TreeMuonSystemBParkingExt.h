...
#ifndef TreeMuonSystemBParkingExt_H
#define TreeMuonSystemBParkingExt_H
...
class TreeMuonSystemBParkingExt
{

public:
  TreeMuonSystemBParkingExt();
  ~TreeMuonSystemBParkingExt();
  TTree *tree_;
  TFile *f_;
