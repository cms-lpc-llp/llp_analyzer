...
// from TTree RazorEventsRun1/selected miniAOD information
// found on file: razorNtuple.root
//////////////////////////////////////////////////////////

#ifndef RazorEventsRun1_h
#define RazorEventsRun1_h
...
//   TBranch        *b_alphasWeights;   //!
   ...
   RazorEventsRun1(TTree *tree=0);
   virtual ~RazorEventsRun1();
...
#ifdef RazorEventsRun1_cxx
RazorEventsRun1::RazorEventsRun1(TTree *tree) : fChain(0) 
{
...
RazorEventsRun1::~RazorEventsRun1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RazorEventsRun1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RazorEventsRun1::LoadTree(Long64_t entry)
{
...
void RazorEventsRun1::Init(TTree *tree)
{
...
void RazorEventsRun1::Show(Long64_t entry)
{
...
Int_t RazorEventsRun1::Cut(Long64_t entry)
{
...
#endif // #ifdef RazorEventsRun1_cxx
