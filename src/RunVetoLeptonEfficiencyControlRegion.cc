...
void usage()
{
  std::cerr << "Usage: RunVetoLeptonEfficiencyControlRegion  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    VetoLeptonEfficiencyControlRegion analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing VetoLeptonEfficiencyControlRegion..." << endl;
    analyzer.EnableAll();
