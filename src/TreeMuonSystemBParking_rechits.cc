...
// Constructor
TreeMuonSystemBParking_rechits::TreeMuonSystemBParking_rechits()
{
  InitVariables();
};
TreeMuonSystemBParking_rechits::~TreeMuonSystemBParking_rechits()
...
void TreeMuonSystemBParking_rechits::InitVariables()
{
...
void TreeMuonSystemBParking_rechits::InitTree()
{
  assert(tree_);
  InitVariables();
...
void TreeMuonSystemBParking_rechits::CreateTree()
{
