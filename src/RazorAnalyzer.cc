...
void RazorAnalyzer::EnableJets(){
	...
	fChain->SetBranchStatus("jetNSV", 1);
	fChain->SetBranchStatus("jetNSVCand", 1);
	fChain->SetBranchStatus("jetNVertexTracks", 1);
	fChain->SetBranchStatus("jetNSelectedTracks", 1);
	fChain->SetBranchStatus("jetDRSVJet", 1);
	fChain->SetBranchStatus("jetFlightDist2D", 1);
	fChain->SetBranchStatus("jetFlightDist2DError", 1);
	fChain->SetBranchStatus("jetFlightDist3D", 1);
	fChain->SetBranchStatus("jetFlightDist3DError", 1);
	fChain->SetBranchStatus("jetSV_x", 1);
	fChain->SetBranchStatus("jetSV_y", 1);
	fChain->SetBranchStatus("jetSV_z", 1);
	fChain->SetBranchStatus("jetSVNTracks", 1);
	fChain->SetBranchStatus("jetSVMass", 1);
	fChain->SetBranchStatus("jetAllMuonPt", 1);
	fChain->SetBranchStatus("jetAllMuonEta", 1);
	fChain->SetBranchStatus("jetAllMuonPhi", 1);
	fChain->SetBranchStatus("jetAllMuonM", 1);
