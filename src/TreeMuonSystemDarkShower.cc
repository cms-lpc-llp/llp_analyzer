...
// Constructor
TreeMuonSystemDarkShower::TreeMuonSystemDarkShower()
{
  InitVariables();
};
TreeMuonSystemDarkShower::~TreeMuonSystemDarkShower()
...
void TreeMuonSystemDarkShower::InitVariables()
{
...
void TreeMuonSystemDarkShower::InitTree()
{
  assert(tree_);
  InitVariables();
...
void TreeMuonSystemDarkShower::LoadTree(const char* file)
{
  f_ = TFile::Open(file);
  assert(f_);
...
void TreeMuonSystemDarkShower::CreateTree()
{
