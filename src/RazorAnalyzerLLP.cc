...
RazorAnalyzerLLP::RazorAnalyzerLLP(TTree *tree) : llp_event(tree)
{
    //turn off all branches
    fChain->SetBranchStatus("*", 0);
}

RazorAnalyzerLLP::~RazorAnalyzerLLP()
{

}

void RazorAnalyzerLLP::Analyze(bool isData, int option, string outputFileName, string label, string process) {
    cout << "Analyze method called on base RazorAnalyzerLLP instance.  Parameters were: " << isData << " " << option << " " << outputFileName << " " << label << endl;
}
...
void RazorAnalyzerLLP::EnablePVAll() {
...
void RazorAnalyzerLLP::EnablePileup(){
...
void RazorAnalyzerLLP::EnableElectrons(){
...
void RazorAnalyzerLLP::EnableTaus(){
...
void RazorAnalyzerLLP::EnableIsoPFCandidates(){
...
void RazorAnalyzerLLP::EnableCaloJets(){
...
void RazorAnalyzerLLP::EnableJets(){
/*
...
void RazorAnalyzerLLP::EnableFatJets(){
...
void RazorAnalyzerLLP::EnableMet(){
...
void RazorAnalyzerLLP::EnableRazor()
{

};

void RazorAnalyzerLLP::EnableCSC()
{
/*
...
void RazorAnalyzerLLP::EnableDT()
{
//rechits part
/*
...
void RazorAnalyzerLLP::EnableMC(){
...
void RazorAnalyzerLLP::EnableGenParticles(){
...
void RazorAnalyzerLLP::EnableLLP(){
...
void RazorAnalyzerLLP::EnableEcalRechits(){
...
float RazorAnalyzerLLP::GetElectronScaleCorrection( double pt, double eta ) {
...
float RazorAnalyzerLLP::GetElectronEffectiveAreaMean(int i, bool use25nsCuts ){
...
float RazorAnalyzerLLP::GetElectronEffectiveArea90(int i, string EraName){
...
bool RazorAnalyzerLLP::isEGammaPOGVetoElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isEGammaPOGLooseElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isEGammaPOGMediumElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isEGammaPOGTightElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isVetoElectron(int i, bool applyID, bool applyIso, string EraName){
  return isMVANonTrigVetoElectron(i, applyID, applyIso, EraName);
}

bool RazorAnalyzerLLP::isLooseElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
...
bool RazorAnalyzerLLP::isMediumElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  double dr = fmax(0.05,fmin(0.2, 10/elePt[i]));
  if (applyID) {
    if (!passEGammaPOGMediumElectronID(i,use25nsCuts, EraName)) pass = false;
...
bool RazorAnalyzerLLP::isTightElectron(int i, bool applyID, bool applyIso, bool use25nsCuts, string EraName){
  bool pass = true;
  double dr = fmax(0.05,fmin(0.2, 10/elePt[i]));
  if (applyID) {
    if (!passEGammaPOGTightElectronID(i,use25nsCuts, EraName)) pass = false;
...
bool RazorAnalyzerLLP::isMVANonTrigVetoElectron(int i, bool applyID, bool applyIso, string EraName){
...
bool RazorAnalyzerLLP::passEGammaPOGVetoElectronID(int i, bool use25nsCuts, string EraName){
    if (!use25nsCuts) {
...
bool RazorAnalyzerLLP::passEGammaPOGLooseElectronID(int i, bool use25nsCuts, string EraName){
    if (!use25nsCuts) {
        std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
        return false;
    }
...
bool RazorAnalyzerLLP::passEGammaPOGMediumElectronID(int i, bool use25nsCuts, string EraName){
  if (!use25nsCuts) {
    std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
    return false;
  }
...
bool RazorAnalyzerLLP::passEGammaPOGTightElectronID(int i, bool use25nsCuts, string EraName){
  if (!use25nsCuts) {
    std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
    return false;
  }
...
bool RazorAnalyzerLLP::passMVANonTrigVetoElectronID(int i, string EraName){
...
bool RazorAnalyzerLLP::passMVAVetoElectronID(int i, string EraName){
...
bool RazorAnalyzerLLP::passMVALooseElectronID(int i, string EraName){
...
bool RazorAnalyzerLLP::passEGammaPOGVetoElectronIso(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::passEGammaPOGLooseElectronIso(int i, bool use25nsCuts){
    // Recommended for analyses performed on 2016 data using 8XX releases.
    if (!use25nsCuts) {
        std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
        return false;
...
bool RazorAnalyzerLLP::passEGammaPOGMediumElectronIso(int i, bool use25nsCuts){
    // Recommended for analyses performed on 2016 data using 8XX releases.
    if (!use25nsCuts) {
        std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
        return false;
...
bool RazorAnalyzerLLP::passEGammaPOGTightElectronIso(int i, bool use25nsCuts){
    // Recommended for analyses performed on 2016 data using 8XX releases.
    if (!use25nsCuts) {
        std::cerr << "Error: 50ns cuts are not implemented for this electron ID" << std::endl;
        return false;
...
bool RazorAnalyzerLLP::passMVANonTrigVetoElectronIso(int i){
...
bool RazorAnalyzerLLP::passHZZElectronPreselection(int i){
...
bool RazorAnalyzerLLP::isHZZElectron(int i){
...
bool RazorAnalyzerLLP::matchTagElectronHLTFilters(int i){
  bool match = false;
  if (
      //Data filters
...
bool RazorAnalyzerLLP::matchProbeElectronHLTFilters(int i){
  bool match = false;
  if (
...
bool RazorAnalyzerLLP::matchProbeSCHLTFilters(int i){
  bool match = false;
  if (
...
bool RazorAnalyzerLLP::matchElectronHLTFilters(int i, string HLTFilter, string analysisTag) {
...
bool RazorAnalyzerLLP::matchElectronHLTFilters2016(int i, string HLTFilter){
  bool match = false;
...
bool RazorAnalyzerLLP::matchElectronHLTFilters2015(int i, string HLTFilter){
  bool match = false;
...
float RazorAnalyzerLLP::GetMuonEffectiveAreaMean(int i, string type ){
...
float RazorAnalyzerLLP::GetMuonEffectiveArea90(int i, string EraName ){
...
bool RazorAnalyzerLLP::isMuonPOGLooseMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isMuonPOGMediumMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isMuonPOGTightMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
  if (applyID) {
...
bool RazorAnalyzerLLP::isVetoMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
...
bool RazorAnalyzerLLP::isLooseMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
  double dr = fmax(0.05,fmin(0.2, 10/muonPt[i]));
  if (applyID) {
    if (!(muonIsLoose[i] && fabs(muon_ip3dSignificance[i]) < 4)) pass = false;
...
bool RazorAnalyzerLLP::isTightMuon(int i, bool applyID, bool applyIso){
  bool pass = true;
  double dr = fmax(0.05,fmin(0.2, 10/muonPt[i]));
  if (applyID) {
...
bool RazorAnalyzerLLP::passHZZMuonPreselection(int i){
  bool pass = false;
  if (muonIsLoose[i]
      && fabs(muon_d0[i]) < 0.5
      && fabs(muon_dZ[i]) < 1.0
...
bool RazorAnalyzerLLP::isHZZMuon(int i){
  bool pass = false;
  if (muonIsLoose[i]
      && fabs(muon_d0[i]) < 0.5
      && fabs(muon_dZ[i]) < 1.0
...
bool RazorAnalyzerLLP::matchTagMuonHLTFilters(int i){
  return  matchMuonHLTFilters(i, "SingleMuon");
}


bool RazorAnalyzerLLP::matchMuonHLTFilters(int i, string HLTFilter){
  bool match = false;
...
bool RazorAnalyzerLLP::isLooseTau(int i){
  bool pass = false;
  if (tau_IsLoose[i]) {
    pass = true;
  }
...
bool RazorAnalyzerLLP::isMediumTau(int i){
  bool pass = false;
  if (tau_IsMedium[i]) {
    pass = true;
  }
...
bool RazorAnalyzerLLP::isTightTau(int i){
  bool pass = false;
  if (tau_IsTight[i]) {
    pass = true;
  }
...
bool RazorAnalyzerLLP::isCSVL(int i, string dataset)
{
  if (dataset == "74X")
  {
...
bool RazorAnalyzerLLP::isCSVM(int i, string dataset)
{
  if (dataset == "74X")
  {
...
bool RazorAnalyzerLLP::isCSVT(int i, string dataset)
{
  if (dataset == "74X")
  {
...
double RazorAnalyzerLLP::JetEnergyCorrectionFactor( double jetRawPt, double jetEta, double jetPhi, double jetE,
...
double RazorAnalyzerLLP::JetEnergySmearingFactor( double jetPt, double jetEta, double NPU, SimpleJetResolution *JetResolutionCalculator, TRandom3 *random ) {
...
double RazorAnalyzerLLP::UpDownJetEnergySmearingFactor(double unsmearedPt, double jetEta, double NPU, SimpleJetResolution *JetResolutionCalculator, double smearedPt, string option){
    //get jet resolution
    std::vector<float> fJetEta, fJetPtNPU;
    fJetEta.push_back(jetEta);
...
double RazorAnalyzerLLP::BTagScaleFactor(double jetPt, bool CSVM, string option){
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
bool RazorAnalyzerLLP::photonPassesElectronVeto(int i){
    //use presence of a pixel seed as proxy for an electron veto
    return (pho_passEleVeto[i]);
}
/*
double RazorAnalyzerLLP::getPhotonSminorSmajor(int ind_pho, bool isSminor){
...
//Spring 15 values
void RazorAnalyzerLLP::getPhotonEffAreaRun2( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0157;
...
void RazorAnalyzerLLP::getPhotonEffArea90( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0360;
...
void RazorAnalyzerLLP::getPhotonEffAreaPFClusterIso( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
      if(fabs (eta) < 0.8 ) {
		effAreaChHad = 0.037;
		effAreaNHad = 0.089;
...
bool RazorAnalyzerLLP::photonPassesIsolation(int i, double PFChHadIsoCut, double PFNeuHadIsoCut, double PFPhotIsoCut, bool useEffectiveArea90, bool usePrivatePF, bool usePFClusterIso){
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassLooseIDWithoutEleVeto(int i, bool use25nsCuts ){
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassMediumIDWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassTightIDWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassLooseDelayedIDWithoutEleVeto(int i, bool use25nsCuts ){
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassMediumDelayedIDWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
// 80X values from EGamma Presentation
// https://indico.cern.ch/event/491517/contributions/2349134/attachments/1359450/2056689/CutBasedPhotonID_24-10-2016.pdf
bool RazorAnalyzerLLP::photonPassTightDelayedIDWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassLooseID(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::photonPassMediumID(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassTightID(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassLooseIso(int i, bool use25nsCuts, bool usePrivatePF, bool usePFClusterIso){
...
// 80X-v2.2 Cuts from EGamma Presentation
// https://indico.cern.ch/event/491548/contributions/2384977/attachments/1377936/2093213/CutBasedPhotonID_25-11-2016.pdf
//bool RazorAnalyzerLLP::photonPassMediumIso(int i, bool use25nsCuts, bool usePrivatePF, bool usePFClusterIso){
bool RazorAnalyzerLLP::photonPassMediumIso(int i, bool use25nsCuts, bool usePrivatePF){
...
bool RazorAnalyzerLLP::photonPassTightIso(int i, bool use25nsCuts, bool usePrivatePF, bool usePFClusterIso){
...
bool RazorAnalyzerLLP::isLoosePhoton(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhoton(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhoton(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isLoosePhotonWithoutEleVeto(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhotonWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhotonWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isLooseDelayedPhotonWithoutEleVeto(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumDelayedPhotonWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightDelayedPhotonWithoutEleVeto(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::matchPhotonHLTFilters(int i, string HLTFilter){
  bool match = false;
...
TLorentzVector RazorAnalyzerLLP::GetCorrectedMomentum( TVector3 vtx, TVector3 phoPos, double phoE )
{
...
bool RazorAnalyzerLLP::photonPassLooseIDWithoutEleVetoExo15004( int i )
{
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassesIsolationExo15004(int i, double PFChHadIsoCut, double PFPhotIsoCut )
{
  double effAreaPhotons = 0.0;
...
void RazorAnalyzerLLP::getPhotonEffAreaExo15004( float eta, double& effAreaPho )
{
  if ( fabs( eta ) < 0.9 )
    {
      effAreaPho = 0.17;
...
bool RazorAnalyzerLLP::photonPassLooseIsoExo15004(int i)
{
  if( fabs(pho_superClusterEta[i]) < 1.4442 )
    {
...
void RazorAnalyzerLLP::getPhotonEffArea90_2017( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0385;
...
void RazorAnalyzerLLP::getPhotonEffAreaRun2_2017( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0385;
...
//photon ID and isolation cuts from https://twiki.cern.ch/twiki/bin/viewauth/CMS/EgammaIDRecipesRun2
bool RazorAnalyzerLLP::photonPassesIsolation_2017(int i, double PFChHadIsoCut, double PFNeuHadIsoCut, double PFPhotIsoCut, bool useEffectiveArea90, bool usePrivatePF){
    //get effective area for isolation calculations
    double effAreaChargedHadrons = 0.0;
    double effAreaNeutralHadrons = 0.0;
    double effAreaPhotons = 0.0;
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassLooseIDWithoutEleVeto_2017(int i, bool use25nsCuts ){
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassMediumIDWithoutEleVeto_2017(int i, bool use25nsCuts){
  bool pass = true;
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassTightIDWithoutEleVeto_2017(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassLooseID_2017(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::photonPassMediumID_2017(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassTightID_2017(int i, bool use25nsCuts){
  bool pass = true;
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassLooseIso_2017(int i, bool use25nsCuts, bool usePrivatePF){
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassMediumIso_2017(int i, bool use25nsCuts, bool usePrivatePF){
...
// 92X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_92X_and_later
bool RazorAnalyzerLLP::photonPassTightIso_2017(int i, bool use25nsCuts, bool usePrivatePF){
...
bool RazorAnalyzerLLP::isLoosePhotonWithoutEleVeto_2017(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhotonWithoutEleVeto_2017(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhotonWithoutEleVeto_2017(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isLoosePhoton_2017(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhoton_2017(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhoton_2017(int i, bool use25nsCuts){
  bool pass = true;
...
void RazorAnalyzerLLP::getPhotonEffArea90_94X( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0112;
...
void RazorAnalyzerLLP::getPhotonEffAreaRun2_94X( float eta, double& effAreaChHad, double& effAreaNHad, double& effAreaPho )
{
  if( fabs( eta ) < 1.0 )
    {
      effAreaChHad = 0.0112;
...
//photon ID and isolation cuts from https://twiki.cern.ch/twiki/bin/viewauth/CMS/EgammaIDRecipesRun2
bool RazorAnalyzerLLP::photonPassesIsolation_94X(int i, double PFChHadIsoCut, double PFNeuHadIsoCut, double PFPhotIsoCut, bool useEffectiveArea90, bool usePrivatePF){
    //get effective area for isolation calculations
    double effAreaChargedHadrons = 0.0;
    double effAreaNeutralHadrons = 0.0;
    double effAreaPhotons = 0.0;
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassLooseIDWithoutEleVeto_94X(int i, bool use25nsCuts ){
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassMediumIDWithoutEleVeto_94X(int i, bool use25nsCuts){
  bool pass = true;
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassTightIDWithoutEleVeto_94X(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassLooseID_94X(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::photonPassMediumID_94X(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::photonPassTightID_94X(int i, bool use25nsCuts){
  bool pass = true;
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassLooseIso_94X(int i, bool use25nsCuts, bool usePrivatePF){
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassMediumIso_94X(int i, bool use25nsCuts, bool usePrivatePF){
...
// 94X values from EGamma twiki
// https://twiki.cern.ch/twiki/bin/view/CMS/CutBasedPhotonIdentificationRun2#Working_points_for_94X_and_later
bool RazorAnalyzerLLP::photonPassTightIso_94X(int i, bool use25nsCuts, bool usePrivatePF){
...
bool RazorAnalyzerLLP::isLoosePhotonWithoutEleVeto_94X(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhotonWithoutEleVeto_94X(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhotonWithoutEleVeto_94X(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isLoosePhoton_94X(int i, bool use25nsCuts){
...
bool RazorAnalyzerLLP::isMediumPhoton_94X(int i, bool use25nsCuts){
  bool pass = true;
...
bool RazorAnalyzerLLP::isTightPhoton_94X(int i, bool use25nsCuts){
  bool pass = true;
...
int RazorAnalyzerLLP::findClosestGenElectron(double eta, double phi) {
  int matchedIndex = -1;
  float minDR = 999.0;
...
int RazorAnalyzerLLP::findClosestGenMuon(double eta, double phi) {
  int matchedIndex = -1;
  float minDR = 999.0;
  for(int j = 0; j < nGenParticle; j++){
    if (gParticleStatus[j] != 1) continue;
...
int RazorAnalyzerLLP::findClosestGenJet(double eta, double phi) {
  int matchedIndex = -1;
  float minDR = 999.0;
...
bool RazorAnalyzerLLP::isGenTau(int index){
...
//Checks if the gParticle is a tau and that comes from a W or a Z
bool RazorAnalyzerLLP::isGenLeptonicTau(int index){
...
int RazorAnalyzerLLP::findClosestGenTau(double eta, double phi) {
  int matchedIndex = -1;
  float minDR = 999.0;
  for(int j = 0; j < nGenParticle; j++){
...
int RazorAnalyzerLLP::findClosestRecoTau(double eta, double phi) {
  int matchedIndex = -1;
  float minDR = 999.0;
...
int RazorAnalyzerLLP::GetTauMatchedID(double eta, double phi){
  int matchedID = 0;
...
int RazorAnalyzerLLP::findClosestParton(float eta, float phi){
...
bool RazorAnalyzerLLP::matchesGenMuon(double eta, double phi){
  bool result = false;
  for(int j = 0; j < nGenParticle; j++){
    if ( deltaR(eta, phi, gParticleEta[j], gParticlePhi[j]) < 0.1 &&
...
bool RazorAnalyzerLLP::matchesGenElectron(double eta, double phi){
  bool result = false;
  for(int j = 0; j < nGenParticle; j++){
    if ( deltaR(eta, phi, gParticleEta[j], gParticlePhi[j]) < 0.1 &&
...
bool RazorAnalyzerLLP::isHadronicDecay(int index, int status) {
    for ( int j = 0; j < nGenParticle; j++ ) {
...
// or -1 if no match
int RazorAnalyzerLLP::getMatchingHardProcessParticleIndex(double eta, double phi,
...
int RazorAnalyzerLLP::getMatchingGenWIndex(double eta, double phi, double r) {
    int index = getMatchingHardProcessParticleIndex(eta, phi, 24, 22, r);
    return index;
}

// Gets index of matching gen top, if any
int RazorAnalyzerLLP::getMatchingGenTopIndex(double eta, double phi, double r) {
...
double RazorAnalyzerLLP::getGenHT(){
  double genHT = 0;
  for(int j = 0; j < nGenParticle; j++){
...
int RazorAnalyzerLLP::getNISR( std::vector<FactorizedJetCorrector*> &JetCorrector, std::vector<std::pair<int,int> > &JetCorrectorIOV ) {
    int NISRJets = 0;
...
double RazorAnalyzerLLP::deltaPhi(double phi1, double phi2) {
...
TLorentzVector RazorAnalyzerLLP::makeTLorentzVector(double pt, double eta, double phi, double energy){
    TLorentzVector vec;
    vec.SetPtEtaPhiE(pt, eta, phi, energy);
    return vec;
}

TLorentzVector RazorAnalyzerLLP::makeTLorentzVectorPtEtaPhiM(double pt, double eta, double phi, double mass){
    TLorentzVector vec;
...
bool RazorAnalyzerLLP::matchesVetoLepton(float eta, float phi, float dR) {
...
double RazorAnalyzerLLP::GetAlphaT(vector<TLorentzVector> jets)
{
    int nJets = jets.size();
...
double RazorAnalyzerLLP::GetDPhiMin(vector<TLorentzVector> jets)
...
vector<TLorentzVector> RazorAnalyzerLLP::getHemispheres(vector<TLorentzVector> jets){
    int nJets = jets.size();
    vector<TLorentzVector> possibleHem1s; //holds possible hemisphere combinations
    vector<TLorentzVector> possibleHem2s;
...
std::vector< std::vector<int> > RazorAnalyzerLLP::getHemispheresV2( std::vector<TLorentzVector> jets )
{
...
double RazorAnalyzerLLP::computeMR(TLorentzVector hem1, TLorentzVector hem2){
    return sqrt(pow(hem1.P() + hem2.P(), 2) - pow(hem1.Pz() + hem2.Pz(), 2));
}

double RazorAnalyzerLLP::computeRsq(TLorentzVector hem1, TLorentzVector hem2, TLorentzVector pfMet){
...
double RazorAnalyzerLLP::GetMT( TLorentzVector visible, TVector3 met )
{
...
double RazorAnalyzerLLP::GetMT( TLorentzVector visible, TLorentzVector met )
{
...
double RazorAnalyzerLLP::GetMTEnergy( TLorentzVector visible, TVector3 met )
{
  TVector3 vis( visible.Px(), visible.Py(), visible.Pz() );
...
double RazorAnalyzerLLP::GetMTEnergy( TLorentzVector visible, TLorentzVector met )
{
  TVector3 _met( met.Px(), met.Py(), met.Pz() );
...
double RazorAnalyzerLLP::GetDphi( TLorentzVector visible, TVector3 met )
{
  TVector3 vis( visible.Px(), visible.Py(), visible.Pz() );
  return vis.DeltaPhi( met );
};

double RazorAnalyzerLLP::GetDphi( TLorentzVector visible, TLorentzVector met )
{
  TVector3 _met( met.Px(), met.Py(), met.Pz() );
...
bool RazorAnalyzerLLP::passesHadronicRazorBaseline(double MR, double Rsq){
    bool passes = true;
...
bool RazorAnalyzerLLP::passesLeptonicRazorBaseline(double MR, double Rsq){
    bool passes = true;
    if(MR < 0 || Rsq < 0) passes = false;
    //temporarily disable these
...
int RazorAnalyzerLLP::SubtractParticleFromCollection(TLorentzVector ToSubtract, vector<TLorentzVector>& Collection, float deltaRMatch){
...
double RazorAnalyzerLLP::calcMT2(float testMass, bool massive, vector<TLorentzVector> jets, TLorentzVector MET, int hemi_seed, int hemi_association)
{
...
int RazorAnalyzerLLP::detID_from_iEtaiPhi(int iEta_or_iX=1, int iPhi_or_iY=1, bool isEB = true, bool isEEMinus = false)
{
	uint32_t detID = 0;
	int Ecal = 3;
	int EcalBarrel=1;
...
int RazorAnalyzerLLP::iEta_or_iX_from_detID(int detID=1, bool isEB = true)
{
	int iEta_or_iX = 0;
...
int RazorAnalyzerLLP::iPhi_or_iY_from_detID(int detID=1, bool isEB = true)
{
	int iPhi_or_iY = 0;
	uint32_t id_ = uint32_t(detID);
	if(isEB)
