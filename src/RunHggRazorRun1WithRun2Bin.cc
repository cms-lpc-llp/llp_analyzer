...
#include <HggRazorRun1WithRun2Bin.h>
...
void usage()
{
  std::cerr << "Usage: RunHggRazorRun1WithRun2Bin  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    HggRazorRun1WithRun2Bin analyzer(theChain);
    
    //------ EXECUTE ------//
    cout << "Executing HggRazorRun1WithRun2Bin..." << endl;
    analyzer.EnableAll();
