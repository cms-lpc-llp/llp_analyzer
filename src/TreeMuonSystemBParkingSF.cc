...
#include "TreeMuonSystemBParkingSF.h"
#include "assert.h"
#include "TTree.h"
#include "DBSCAN.h"

// Constructor
TreeMuonSystemBParkingSF::TreeMuonSystemBParkingSF()
{
  InitVariables();
};
TreeMuonSystemBParkingSF::~TreeMuonSystemBParkingSF()
...
void TreeMuonSystemBParkingSF::InitVariables()
{
...
void TreeMuonSystemBParkingSF::InitTree()
{
  assert(tree_);
  InitVariables();
...
void TreeMuonSystemBParkingSF::LoadTree(const char* file)
{
  f_ = TFile::Open(file);
  assert(f_);
...
void TreeMuonSystemBParkingSF::CreateTree()
{
