//---------------------------------------------------------------------------
#ifndef ROO_Razor3DBinMRSlopePdf
#define ROO_Razor3DBinMRSlopePdf
//---------------------------------------------------------------------------
#include "RooAbsPdf.h"
...
//---------------------------------------------------------------------------
class RooRazor3DBinMRSlopePdf : public RooAbsPdf
{
public:
   RooRazor3DBinMRSlopePdf() {} ;
   RooRazor3DBinMRSlopePdf(const char *name, const char *title,
		    RooAbsReal& _th1x,
     ...
     //TH3* _Hnominal);
   RooRazor3DBinMRSlopePdf(const RooRazor3DBinMRSlopePdf& other,
      const char* name = 0);
   void setTH3Binning(TH3* _Hnominal);
   virtual TObject* clone(const char* newname) const { return new RooRazor3DBinMRSlopePdf(*this,newname); }
   inline virtual ~RooRazor3DBinMRSlopePdf() { }
...
private:
  ClassDef(RooRazor3DBinMRSlopePdf,1) // Razor2DTail_SYS function
