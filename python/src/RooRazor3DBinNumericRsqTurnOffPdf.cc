...
#include "RooRazor3DBinNumericRsqTurnOffPdf.h"
...
ClassImp(RooRazor3DBinNumericRsqTurnOffPdf)
//---------------------------------------------------------------------------
RooRazor3DBinNumericRsqTurnOffPdf::RooRazor3DBinNumericRsqTurnOffPdf(const char *name, const char *title,
				   RooAbsReal& _th1x,  
...
//---------------------------------------------------------------------------
RooRazor3DBinNumericRsqTurnOffPdf::RooRazor3DBinNumericRsqTurnOffPdf(const RooRazor3DBinNumericRsqTurnOffPdf& other, const char* name) :
...
//---------------------------------------------------------------------------
void RooRazor3DBinNumericRsqTurnOffPdf::setTH3Binning(TH3* _Hnominal){
...
//---------------------------------------------------------------------------
void RooRazor3DBinNumericRsqTurnOffPdf::setRelTol(double _relTol){
  relTol = _relTol;
}
//---------------------------------------------------------------------------
void RooRazor3DBinNumericRsqTurnOffPdf::setAbsTol(double _absTol){
  absTol = _absTol;
}
//---------------------------------------------------------------------------
Double_t RooRazor3DBinNumericRsqTurnOffPdf::evaluate() const
{
...
// //---------------------------------------------------------------------------
Int_t RooRazor3DBinNumericRsqTurnOffPdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const{
  if (matchArgs(allVars, analVars, th1x)) return 1;
  return 0;
}

// //---------------------------------------------------------------------------
Double_t RooRazor3DBinNumericRsqTurnOffPdf::analyticalIntegral(Int_t code, const char* rangeName) const{
   ...
   if (code==1 && iBinMin<=0 && iBinMax>=nBins){
     ...
     cout << "WARNING IN RooRazor3DBinNumericRsqTurnOffPdf: integration code is not correct" << endl;
