...
#include "RooRazor3DBinErrorPdf.h"
...
ClassImp(RooRazor3DBinErrorPdf)
//---------------------------------------------------------------------------
RooRazor3DBinErrorPdf::RooRazor3DBinErrorPdf(const char *name, const char *title,
				   RooAbsReal& _th1x,  
...
//---------------------------------------------------------------------------
RooRazor3DBinErrorPdf::RooRazor3DBinErrorPdf(const RooRazor3DBinErrorPdf& other, const char* name) :
...
//---------------------------------------------------------------------------
void RooRazor3DBinErrorPdf::setTH3Binning(TH3* _Hnominal){
...
//---------------------------------------------------------------------------
Double_t RooRazor3DBinErrorPdf::evaluate() const
{
...
// //---------------------------------------------------------------------------
Int_t RooRazor3DBinErrorPdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const{
  if (matchArgs(allVars, analVars, th1x)) return 1;
  return 0;
}

// //---------------------------------------------------------------------------
Double_t RooRazor3DBinErrorPdf::analyticalIntegral(Int_t code, const char* rangeName) const{
   ...
   if(code==1) { 
     ...
     cout << "WARNING IN RooRazor3DBinErrorPdf: integration code is not correct" << endl;
