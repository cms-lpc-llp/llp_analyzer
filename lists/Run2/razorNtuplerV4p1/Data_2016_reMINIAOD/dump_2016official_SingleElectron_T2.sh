...
do
	...
	subBase1=${baseDir}crab_prod_CaltechT2_Run2RazorNtuplerV4p1_SingleElectron_${run}_ReMiniAOD2016Official_v1_06Aug2018/
	echo ${subBase1}
	...
	do
		...
		do
			...
			do
				echo "${subBase3}${ifile}" >> SingleElectron_${run}_06Aug2018.cern.txt
			done
		done
	done
