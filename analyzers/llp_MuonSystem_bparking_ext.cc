#include "llp_MuonSystem_bparking_ext.h"
...
void llp_MuonSystem_bparking_ext::Analyze(bool isData, int options, string outputfilename, string analysisTag)
{
  ...
  TreeMuonSystemBParkingExt *MuonSystem = new TreeMuonSystemBParkingExt;
