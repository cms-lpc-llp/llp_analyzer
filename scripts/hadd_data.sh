ver=V1p17
ver2=/v1/
outputRoot=Run2_displacedJetMuonNtupler_${ver}_Data2016_-HighMET_goodLumi.root
dir1=/store/group/phys_exotica/delayedjets/displacedJetTimingAnalyzer/${ver}/Data2016/${ver2}/normalized/
