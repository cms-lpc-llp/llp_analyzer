...
DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.cern\
DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.cern\
...
ST_tW_antitop_5f_DS_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1\
ST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1\
ST_tW_top_5f_DS_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1\
...
ZZTo2L2Nu_13TeV_powheg_pythia8\
  ...
  setenv LSB_JOB_REPORT_MAIL N
  set inputfilelist="/afs/cern.ch/work/c/cpena/public/CMSSW_7_5_3_patch1/src/RazorAnalyzer/lists/Run2/razorNtuplerV1p23/MC/25ns/${sample}.cern.txt"
  set filesPerJob = 5
  set nfiles = `cat $inputfilelist | wc | awk '{print $1}' `
  set maxjob=`python -c "print int($nfiles.0/$filesPerJob)-1"`
  echo "Sample " $sample " maxjob = " $maxjob
  ...
  foreach jobnumber(`seq 0 1 $maxjob`)
    if ( ! -e /afs/cern.ch/work/c/cpena/public/eosDir/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/jobs/CP/RunTwoRazorControlRegions_CP_TwoLeptonFull_${sample}.Job${jobnumber}Of${maxjob}.root ) then
	echo "job " $jobnumber " out of " $maxjob
	bsub -q 8nm -o /afs/cern.ch/work/c/cpena/public/logSubmit/RunTwoRazorControlRegions_TwoLeptonFull_${sample}_${jobnumber}.out -J RunTwoRazorControlRegions_TwoLeptonFull_${sample}_${jobnumber} /afs/cern.ch/work/c/cpena/public/CMSSW_7_5_3_patch1/src/RazorAnalyzer/scripts/runRazorJob_CERN_EOS.csh RazorControlRegions $inputfilelist --isData=False 3 $filesPerJob $jobnumber RunTwoRazorControlRegions_CP_TwoLeptonFull_${sample}.Job${jobnumber}Of${maxjob}.root /store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/jobs/CP
	sleep 0.1
    endif
  end
end
