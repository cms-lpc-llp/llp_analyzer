...
hadd ${outputRoot[1]} /mnt/hadoop/${dir[1]}/Run2_displacedJetMuonNtupler_V1p17_Data2017_AOD_Run2017B-17Nov2017.root /mnt/hadoop/${dir[1]}/Run2_displacedJetMuonNtupler_V1p17_Data2017_AOD_Run2017C-17Nov2017.root /mnt/hadoop/${dir[1]}/Run2_displacedJetMuonNtupler_V1p17_Data2017_AOD_Run2017D-17Nov2017.root /mnt/hadoop/${dir[1]}/Run2_displacedJetMuonNtupler_V1p17_Data2017_AOD_Run2017E-17Nov2017.root /mnt/hadoop/${dir[1]}/Run2_displacedJetMuonNtupler_V1p17_Data2017_AOD_Run2017F-17Nov2017.root

hadd ${outputRoot[2]} /mnt/hadoop/${dir[2]}/Run2_displacedJetMuonNtupler_V1p17_Data2018_17Sept2018_AOD_Run2018A-17Sep2018-v2.root /mnt/hadoop/${dir[2]}/Run2_displacedJetMuonNtupler_V1p17_Data2018_17Sept2018_AOD_Run2018A-17Sep2018-v2_part2.root /mnt/hadoop/${dir[2]}/Run2_displacedJetMuonNtupler_V1p17_Data2018_17Sept2018_AOD_Run2018B-17Sep2018.root /mnt/hadoop/${dir[2]}/Run2_displacedJetMuonNtupler_V1p17_Data2018_17Sept2018_AOD_Run2018C-17Sep2018.root /mnt/hadoop/${dir[3]}/Run2_displacedJetMuonNtupler_V1p17_Data2018D_17Sept2018_AOD_Run2018D-PromptReco.root
