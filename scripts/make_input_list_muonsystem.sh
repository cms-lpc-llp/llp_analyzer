#!/bin/bash
root_dir=/mnt/hadoop/store/group/phys_exotica/delayedjets/displacedJetMuonNtuple/V1p7/MC_Summer16/v5/sixie/
list_dir=$CMSSW_BASE/src/llp_analyzer/lists/displacedJetMuonNtuple/V1p7/MC_Summer16/v5/sixie/
echo $list_dir
mkdir -p $list_dir
for sample in \
