#!/bin/sh 
dir=/store/group/phys_exotica/delayedjets/displacedJetMuonAnalyzer/csc/V1p17/MC_Fall18/v2/v90/normalized/
...
hadd ${outputRoot} /mnt/hadoop/$dir/ggZHToSS_SToBB_ZToLL_ms40_pl1000_137000pb_weighted.root /mnt/hadoop/$dir/ggZHToSS_SToBB_ZToNuNu_ms40_pl1000_137000pb_weighted.root /mnt/hadoop/$dir/ggZHToSS_SToBB_ZToQQ_ms40_pl1000_137000pb_weighted.root
