#not tested after change in tier2, where only gfal commands are allowed
#dir=/store/group/phys_exotica/delayedjets/llp_analyzer/V1p0/MC_Summer16/v1/
dir=/mnt/hadoop/store/group/phys_exotica/delayedjets/llp_analyzer/V1p0/MC_Summer16/v1/bkg/
# hadd each bin
for sample in \
...
do
        ...
        echo "Sample " ${sample}
#	hadd ${sample}.root /mnt/hadoop/${dir}/${sample}/*
	cp ${dir}${sample}/${sample}_Job0_Of_0.root .
...
#	then
#		gfal-copy ${sample}_1pb_weighted.root gsiftp://transfer.ultralight.org//${dir}/normalized/${sample}_1pb_weighted.root
