...
years=['Data2016']
goldenLumi['Data2018'] = os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/officialJson/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt'
sampleName['Data2018'] = [   
]
goldenLumi['Data2017'] = os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/officialJson/Cert_294927-306462_13TeV_PromptReco_Collisions17_JSON.txt'
sampleName['Data2017'] = [
	]

goldenLumi['Data2016'] = os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/officialJson/Cert_271036-284044_13TeV_ReReco_07Aug2017_Collisions16_JSON.txt'
sampleName['Data2016'] = [
...
for year in years:
    ...
    list_dir=os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/displacedJetMuonNtuple/V1p17/'+year+'/'
	...
	inputfile = list_dir+sample+'.txt'
 	...
 	root_dir = '/mnt/hadoop/store/group/phys_exotica/delayedjets/displacedJetMuonNtuple/V1p17/Data2016/v4/sixie/MET/'+sample+'/*/*/'
        print(root_dir)
        print(inputfile)
...
#	lumiTarball = os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/Json_from_crab_prod/displacedJetMuonNtuple/V1p15/'+year+'/'+sample+'/run_and_lumis.tar.gz'
#	outputJson = os.getenv("CMSSW_BASE")+'/src/cms_lpc_llp/llp_analyzer/lists/Json_from_crab_prod/displacedJetMuonNtuple/V1p15/'+year+'/'+sample+'/'+sample+'_goodLumi.json'
