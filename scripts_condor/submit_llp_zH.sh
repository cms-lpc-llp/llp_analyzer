...
do
	...
	do
		...
		echo "Arguments = ${analyzer} ${inputfilelist} no 12 ${filesPerJob} ${jobnumber} ${sample}_Job${jobnumber}_Of_${maxjob}.root /store/group/phys_exotica/delayedjets/llp_analyzer/V1p0/MC_Summer16/v6/signals/zH/${sample} ${analyzerTag} " >> ${jdl_file}
