...
Run2_displacedJetMuonNtupler_${ver}_Data2017_AOD_Run2017G-17Nov2017
Run2_displacedJetMuonNtupler_${ver}_Data2017_AOD_Run2017H-17Nov2017
)
listData2018ABC=(
Run2_displacedJetMuonNtupler_${ver}_Data2018_17Sept2018_AOD_Run2018A-17Sep2018
...
listData2018D=(
Run2_displacedJetMuonNtupler_V1p17_Data2018D_17Sept2018_AOD_Run2018D-PromptReco
)
for year in \
Data2016 \
Data2017 \
...
do
        echo ${year}
	inputDir=/store/group/phys_exotica/delayedjets/displacedJetMuonAnalyzer/csc/${ver}/${year}_AOD/v5/v63/
	echo ${inputDir}
