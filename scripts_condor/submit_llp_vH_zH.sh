...
do
	...
	do
		...
		echo "Arguments = ${analyzer} ${inputfilelist} no 1 zH ${filesPerJob} ${jobnumber} ${sample}_Job${jobnumber}_Of_${maxjob}.root /store/group/phys_exotica/delayedjets/llp_analyzer/V1p0/MC_Summer16/v1/signal/${sample} ${analyzerTag} " >> ${jdl_file}
