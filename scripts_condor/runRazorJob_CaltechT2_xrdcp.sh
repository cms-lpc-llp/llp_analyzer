...
then
	...
	then 
		...
		echo "************************************"
		echo ""
		#xrdcp files to local
		for ifile in `cat inputfilelistForThisJob_${jobnumber}.txt`
		do
			xrdcp ${ifile} ./
		done
		ls razorNtuple_* > inputfilelistForThisJob_${jobnumber}_local.txt

		#check if copy successfull
		...
		then
			echo "************************************"
			echo "Running on these local input files"
			cat inputfilelistForThisJob_${jobnumber}_local.txt
			echo "************************************"
