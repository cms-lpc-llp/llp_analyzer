...
job_script=${RazorAnalyzerDir}/scripts_condor/normalize_central.sh
	...
	do
		...
		do
			ctau_list=ctau_${sample:0:3}[@]
				...
				analyzer=SusyLLP
				inputDir=/store/group/phys_exotica/delayedjets/displacedJetTimingAnalyzer/V1p17/v13/MC_${year}/
