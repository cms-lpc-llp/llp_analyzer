...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         pho_sumChargedHadronPt_NewPV_NoTiming[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx[700];   //[nPhotons]

   Float_t         pho_sumChargedHadronPt_NewPV_Timing50_TrkPho[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing80_TrkPho[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing100_TrkPho[700];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt_NewPV_Timing120_TrkPho[700];   //[nPhotons]
   ...
   bool            gParticle_isPromptFinalState[4000];   //[nGenParticle]
   bool            gParticle_isPromptDecayed[4000];   //[nGenParticle]
   ...
   TBranch        *b_pho_sumChargedHadronPt_NewPV_NoTiming;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx;   //!

   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing50_TrkPho;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing80_TrkPho;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing100_TrkPho;   //!
   TBranch        *b_pho_sumChargedHadronPt_NewPV_Timing120_TrkPho;   //!
   ...
   TBranch        *b_gParticle_isPromptFinalState;   //!
   TBranch        *b_gParticle_isPromptDecayed;   //!
...
void RazorEvents::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pvZ_New_dzt", &pvZ_New, &b_pvZ_New);
   fChain->SetBranchAddress("pvdT_New_dzt", &pvdT_New, &b_pvdT_New);
   fChain->SetBranchAddress("pvdZ_New_dzt", &pvdZ_New, &b_pvdZ_New);
   ...
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_NoTiming", pho_sumChargedHadronPt_NewPV_NoTiming, &b_pho_sumChargedHadronPt_NewPV_NoTiming);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx", pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx, &b_pho_sumChargedHadronPt_NewPV_Timing50_TrkVtx);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx", pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx, &b_pho_sumChargedHadronPt_NewPV_Timing80_TrkVtx);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx", pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx, &b_pho_sumChargedHadronPt_NewPV_Timing100_TrkVtx);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx", pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx, &b_pho_sumChargedHadronPt_NewPV_Timing120_TrkVtx);
  
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing50_TrkPho", pho_sumChargedHadronPt_NewPV_Timing50_TrkPho, &b_pho_sumChargedHadronPt_NewPV_Timing50_TrkPho);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing80_TrkPho", pho_sumChargedHadronPt_NewPV_Timing80_TrkPho, &b_pho_sumChargedHadronPt_NewPV_Timing80_TrkPho);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing100_TrkPho", pho_sumChargedHadronPt_NewPV_Timing100_TrkPho, &b_pho_sumChargedHadronPt_NewPV_Timing100_TrkPho);
   fChain->SetBranchAddress("pho_sumChargedHadronPt_NewPV_Timing120_TrkPho", pho_sumChargedHadronPt_NewPV_Timing120_TrkPho, &b_pho_sumChargedHadronPt_NewPV_Timing120_TrkPho);
   ...
   fChain->SetBranchAddress("gParticle_isPromptFinalState", gParticle_isPromptFinalState, &b_gParticle_isPromptFinalState);
   fChain->SetBranchAddress("gParticle_isPromptDecayed", gParticle_isPromptDecayed, &b_gParticle_isPromptDecayed);
