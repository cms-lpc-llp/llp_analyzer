...
void PhotonIsolation_FromNtuple_Fake()
...
//  h_PhoChargedHadronIso_NewPV_Timing50_TrkVtx->Draw("same");
 ...
 // h_PhoChargedHadronIso_NewPV_Timing120_TrkPho->Draw("same");
  ...
  h_PhoChargedHadronIso_NewPV_NoTiming->GetYaxis()->SetRangeUser(0,60);


//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake.pdf");
//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake.png");
//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake.C");
...
//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake_Timing80_TrkVtx_bins.pdf");
//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake_Timing80_TrkVtx_bins.png");
//  cv->SaveAs("~/www/sharebox/tomyself/Timing/h_chargedHadronPt_Fake_Timing80_TrkVtx_bins.C");
...
//  gr_Timing120_TrkPho->SetLineColor(kGreen);
 // gr_Timing120_TrkPho->SetLineWidth(2);
  ...
  gr_NoTiming->GetYaxis()->SetTitle("Fake Photon Charged Isolation Eff (%)");
  gr_NoTiming->GetYaxis()->SetTitleOffset(1.2);
  gr_NoTiming->GetYaxis()->SetTitleSize(0.045);
  gr_NoTiming->GetYaxis()->SetRangeUser(0,4);
  gr_NoTiming->GetXaxis()->SetRangeUser(0,2.0);

  cv->SaveAs("~/www/sharebox/tomyself/Timing/photonIsolationEff_Fake_withCut.pdf");
  cv->SaveAs("~/www/sharebox/tomyself/Timing/photonIsolationEff_Fake_withCut.png");
  cv->SaveAs("~/www/sharebox/tomyself/Timing/photonIsolationEff_Fake_withCut.C");
