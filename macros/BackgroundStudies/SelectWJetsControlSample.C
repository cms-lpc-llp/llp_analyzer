...
void RunSelectWJetsSingleLeptonControlSample( vector<string> datafiles, vector<vector<string> > bkgfiles, vector<string> bkgLabels, 
 ...
 //  assert(pileupWeightHist);
  ...
  for (uint i=0; i < inputfiles.size(); ++i) {
    ...
    histLep1Eta.push_back(new TH1D(Form("histLep1Eta_%s",processLabels[i].c_str()), "; Lepton #eta ; Number of Events", 50, -3, 3));
    histLep1MT.push_back(new TH1D(Form("histLep1MT_%s",processLabels[i].c_str()), "; Lep1MT [GeV/c] ; Number of Events", 100, 0, 300));
    histMET.push_back(new TH1D(Form("histMET_%s",processLabels[i].c_str()), "; MET [GeV/c] ; Number of Events", 50, 0, 500));
    ...
    histHT.push_back(new TH1D(Form("histHT_%s",processLabels[i].c_str()), "; H_{T} [GeV/c^{2}]; Number of Events", 70, 0, 3500));
  ...
  for (uint i=0; i < inputfiles.size(); ++i) {
	...
	// if (processLabels[i] == "QCD" && channelOption == 0 && fabs(events->lep1.Eta()) < 1.5) weight = weight * 1.5;
	// if (processLabels[i] == "QCD" && channelOption == 0 && fabs(events->lep1.Eta()) >= 1.5) weight = weight * 1.75;
	//if (processLabels[i] == "QCD" && channelOption == 0 && abs(events->lep1Type) == 11 && fabs(events->lep1.Eta()) >= 1.5) weight = weight * 1.5;
	// if (processLabels[i] == "QCD" && channelOption == 1 && fabs(events->lep1.Eta()) >= 1.5) weight = weight * 0.7;
	...
	if ( events->HLTDecision[2] || events->HLTDecision[7] || events->HLTDecision[12] 
	     || events->HLTDecision[11] || events->HLTDecision[15]
	     )  
	  passTrigger = true;
	...
	if (!isData) {
	  ...
	  //   if (events->lep1.Pt() < 35) triggerEffScaleFactor = 1.1;
	  //   else if (events->lep1.Pt() < 40) triggerEffScaleFactor = 1.07;
	  //   else if (events->lep1.Pt() < 50) triggerEffScaleFactor = 1.04;
	  // }
	...
	if (isData) {
	  ...
	  if (events->NJets80 >= 2 && events->MR > 0) {
	    ...
	    histHT[i]->Fill(events->HT, weight);
	  }
  ...
  PlotDataAndStackedBkg( histHT, processLabels, color, true, "HT", Label);
...
void SelectWJetsControlSample( int option = -1) {
  ...
  //MR300 Skims
  if (option == 1 || option == 11 || option == 12 || option == 101 || option == 102) {
    datafiles.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_SingleMuon_Run2015D_GoodLumiGolden_RazorSkim.root");
  } 
  if (option == 0 || option == 10 || option == 12 || option == 100 || option == 102) {
  }
  ...
  if (option >= 100) {
    bkgfiles_wjets.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_WJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_1pb_weighted.root_RazorSkim.root");
  } else {
    //bkgfiles_wjets.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_WJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_1pb_weighted.root_RazorSkim.root");
    bkgfiles_wjets.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_WJetsToLNu_HTBinned_1pb_weighted_RazorSkim.root");
  }

  bkgfiles_ttbar.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_TTJets_1pb_weighted_RazorSkim.root");
  bkgfiles_singletop.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_SingleTop_1pb_weighted_RazorSkim.root");
  bkgfiles_dy.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_DYJetsToLL_HTBinned_1pb_weighted_RazorSkim.root");
  bkgfiles_vv.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_VVV_1pb_weighted_RazorSkim.root");
  bkgfiles_vv.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_TTV_1pb_weighted_RazorSkim.root");

  // if (option == 10 || option == 11 || option == 12 ) {
  //   //bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_HTBinned_1pb_weighted.root_RazorSkim.root");
  //   //bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_Pt-15to7000_TuneCUETP8M1_Flat_13TeV_pythia8_1pb_weighted.root_RazorSkim.root");
  //   // bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_MuEnriched_1pb_weighted.root");
  //   // bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_EMEnriched_1pb_weighted.root");
  // }
  // if (option == 101 ||  option == 102 ) {
  //   bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_MuEnriched_1pb_weighted.root");
  // }
  // if (option == 100 ||  option == 102) {
  //   bkgfiles_qcd.push_back("/afs/cern.ch/user/s/sixie/eos2/cms/store/group/phys_susy/razor/Run2Analysis/RunTwoRazorControlRegions/OneLeptonFull_1p23_2015Final/RazorSkim/RunTwoRazorControlRegions_OneLeptonFull_SingleLeptonSkim_QCD_EMEnriched_1pb_weighted.root");
  // }

  bkgfiles_znunu.push_back("");
  ...
  //*********************************************************************
  if (option == 0) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"MR300Rsq0p15_ZeroMediumBTag",0,"MR300Rsq0p15_ZeroMediumBTag_SingleEle");
  }
  if (option == 10) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"MR300Rsq0p15_ZeroLooseBTag",0,"MR300Rsq0p15_ZeroLooseBTag_SingleEle");
  }
  if (option == 100) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"Inclusive",0,"Inclusive_SingleEle");
  }
  ...
  //*********************************************************************
  if (option == 1) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"MR300Rsq0p15_ZeroMediumBTag",1,"MR300Rsq0p15_ZeroMediumBTag_SingleMu");
  }
  if (option == 11) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"MR300Rsq0p15_ZeroLooseBTag",1,"MR300Rsq0p15_ZeroLooseBTag_SingleMu");
  }
  if (option == 101) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"Inclusive",1,"Inclusive_SingleMu");
  }
  ...
  //*********************************************************************
  if (option == 12) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"MR300Rsq0p15_ZeroMediumBTag",-1,"MR300Rsq0p15_ZeroMediumBTag_All");
  }
  if (option == 102) {
    RunSelectWJetsSingleLeptonControlSample(datafiles, bkgfiles,processLabels,  colors, lumi,"Inclusive",-1,"Inclusive_All");
  }
