...
//   factory->AddVariable( "logchi2_pho_vtx",	'F');
   ...
   factory->AddVariable( "limPullToConv",'F');
   factory->AddVariable( "nConv",	'F');
   ...
   factory->AddSignalTree( signal->CopyTree(cutTrain), signalWeight, "Training" ); 
   factory->AddSignalTree( signal->CopyTree(cutTest), signalWeight, "Test" ); 
