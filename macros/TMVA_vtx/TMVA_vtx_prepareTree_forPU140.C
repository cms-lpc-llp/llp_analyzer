...
void TMVA_vtx_prepareTree_forPU140(string inputFilename = "../../HggRazorUpgradeTiming_PU140_NoTiming.root", string outputFilename = "HggRazorUpgradeTiming_PU140_NoTiming_vtx.root")
{
	unsigned int event;
