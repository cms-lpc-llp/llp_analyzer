...
//*************************************************************************************************
void MakeElectronIsoPerformancePlots(string InputFile, string Label, Int_t Option)
{  
  ...
  for(UInt_t ientry=0; ientry < EleTree->tree_->GetEntries(); ientry++) {       	
    ...
    if (!passCSA14VetoID(EleTree)) continue;
  ...
  //*****************************************************************************************
  cout << "CSA14 VetoIso Real Electron Efficiency : " << RealElectronPassCSA14VetoIso << " / " << RealElectrons << " = " << RealElectronPassCSA14VetoIso/RealElectrons << endl;
  ...
  //*****************************************************************************************
  Double_t CutValue_PFIso_98 = FindCutValueAtFixedEfficiency(ElePFIso_Real, 0.98 );
  Double_t CutValue_PFIso_95 = FindCutValueAtFixedEfficiency(ElePFIso_Real, 0.95 );
  Double_t CutValue_PFIso_90 = FindCutValueAtFixedEfficiency(ElePFIso_Real, 0.90 );
  Double_t CutValue_PFIso_85 = FindCutValueAtFixedEfficiency(ElePFIso_Real, 0.85 );
  Double_t CutValue_PFIso_80 = FindCutValueAtFixedEfficiency(ElePFIso_Real, 0.80 );
  ...
  Double_t CutValue_PFRelIso_98 = FindCutValueAtFixedEfficiency(ElePFRelIso_Real, 0.98 );
  Double_t CutValue_PFRelIso_95 = FindCutValueAtFixedEfficiency(ElePFRelIso_Real, 0.95 );
  Double_t CutValue_PFRelIso_90 = FindCutValueAtFixedEfficiency(ElePFRelIso_Real, 0.90 );
  Double_t CutValue_PFRelIso_85 = FindCutValueAtFixedEfficiency(ElePFRelIso_Real, 0.85 );
  Double_t CutValue_PFRelIso_80 = FindCutValueAtFixedEfficiency(ElePFRelIso_Real, 0.80 );
