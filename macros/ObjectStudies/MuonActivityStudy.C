...
Bool_t passVetoID( MuonTree *muTree) {

  bool pass = false;
  if ( muTree->fMuIsLoose 
       && fabs(muTree->fMuIP3dSig) < 4
      ) {
    pass = true;
  }   
  return pass;
...
bool PassVetoIso( MuonTree* muTree ) {

  bool pass = false;
  double dr = fmax(0.05,fmin(0.2, 10/muTree->fMuPt));
  pass = bool( muTree->fMiniIsoDBCorr / muTree->fMuPt < 0.2 );
  return pass;
}
...
void MuonActivityStudy( int option = 1) {

  if (option == 1) {
   
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_TTJets_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_TTJets_HT-2500toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_TTJetsHT2500ToInf_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_TTJets_HT-600to800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_TTJetsHT600To800_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_TTJets_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root", 1, 0, "PromptMuon_TTJets_aMCAtNLO_25ns_MiniIsoCut");

    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_WJetsToLNu_HT-2500ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_WJetsHT2500ToInf_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_WJetsToLNu_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_WJetsHT400To600_25ns_MiniIsoCut");

    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_DYJetsToLL_M-50_HT-600toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_DYJetsHT600ToInf_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_DYJetsToLL_M-50_HT-200to400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8.root", 1, 0, "PromptMuon_DYJetsHT200To400_25ns_MiniIsoCut");

    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_TTJetsMadgraphAll.root", 1, 0, "PromptMuon_TTJetsMadgraphAll_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_WJetsMadgraphAll.root", 1, 0, "PromptMuon_WJetsMadgraphAll_25ns_MiniIsoCut");
    // MakeMuonEfficiencyVsActivityPlots("/afs/cern.ch/user/s/sixie/eos/cms/store/group/phys_susy/razor/Run2Analysis/MuonNtuple/V1p17/MuonNtuple_Prompt_DYJetsMadgraphAll.root", 1, 0, "PromptMuon_DYJetsMadgraphAll_25ns_MiniIsoCut");
