...
class RazorHelper {
	...
	double getDiphotonTrigLeadingLegEffSF(float pt, float eta);
   	double getDiphotonTrigTrailingLegEffSF(float pt, float eta);
        ...
        bool isWTaggedAK8Jet(RazorAnalyzerLLP *ra, uint iJet, bool isData, int updown=0);
        bool isTopTaggedAK8Jet(RazorAnalyzerLLP *ra, uint iJet);
        ...
        AK8JetInfo CalcAK8JetInfo(RazorAnalyzerLLP *ra, bool isData);
