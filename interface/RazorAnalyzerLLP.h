...
#ifndef RazorAnalyzerLLP_h
#define RazorAnalyzerLLP_h

#include "LLPAnalysis/llpAnalyzer/interface/llp_event.h" //This is a MakeClass of the llp tree in the ntuple to be analyzed
...
class RazorAnalyzerLLP: public llp_event {
    public :
        RazorAnalyzerLLP(TTree *tree=0);
        virtual ~RazorAnalyzerLLP();
        ...
        //------ LIST OF ANALYSES ------//
        virtual void Analyze(bool isData, int option, string outputFileName, string label, string process);
